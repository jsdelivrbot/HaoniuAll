<template>
	<div class="databank">
		...
		<div class="list">
			...
			<ul>
				<li v-for="item in list.list" :class="{video:item.type==1,img:item.type!==1}">
		...
		<div class="actionsheet" v-show="actionsheetshow">
			<ul>
				<li class="vux-1px-b">
					<input type="file" @change="uploadVideo"> 视频
				</li>
				<li>
					<input type="file" id="upload2" accept="image/*" @change="uploadImg">图片
				</li>
