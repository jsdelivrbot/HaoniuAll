	...
	<div class="searchlist">
		<div class="search-box vux-1px-b">
			...
			<span v-if="maporList==='map'" @click="changeml('list')">
				<img src="~IMG/iconlist.png"/>
			</span>
			<span v-if="maporList!=='map'" @click="changeml('map')">
				<img src="~IMG/iconmap.png"/>
			</span>
		</div>
...
<script>
	...
	import searchresult from '@/components/pubcomponents/searchresult'
		...
		.select-box {
			...
			.select-list {
				...
				li {
					...
					font-size: 14px;
					color: #999;
					background: url(~IMG/selectdown1.png) no-repeat;
					background-size: 9px auto;
					background-position: 78% 50%;
				}
				.active {
					color: #333333;
					background-image: url(~IMG/selectdown2.png);
				}
			}
		}
		.search-box {
