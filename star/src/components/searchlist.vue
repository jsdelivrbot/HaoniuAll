<template>
	<div class="searchlist">
		...
		<!--<mapes @abcd='getaddress' :center='maplist' v-if='ismaps!==""'></mapes>-->
	...
	export default {
		...
		methods: {
			...
			searchall() {
				this.lod()
				this.ismaps = ''
				console.log(this.searchdata.dist)

				if(this.searchdata.lng === localStorage.getItem('lng')) {
					this.searchdata.style = 1
				} else {
