<template>
	<div class="vehicle-info-box">
		...
		<group>
			<x-input title="承运车辆：" :value="formInfo.realname + '，' + formInfo.cart_badge_no + '，' + formInfo.mobile_no" :disabled="true"></x-input>
		</group>
		<group label-width="102px">
			<x-input title="运单号:" placeholder="请输入运单号" :value="formInfo.waybill_no" :max="20"></x-input>
