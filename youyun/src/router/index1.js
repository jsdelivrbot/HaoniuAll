...
const router = new Router({
	routes: [{
		...
		},
		{
			path: '/PasswordManage',
			component: function(resolve) {
				require(['@/components/fukuan/PasswordManage'], resolve)
			}
		},
		{
			path: '/TransactionRecord',
			component: function(resolve) {
				require(['@/components/fukuan/TransactionRecord'], resolve)
			}
		},
		{
			path: '/RechargeRecord',
			component: function(resolve) {
				require(['@/components/fukuan/RechargeRecord'], resolve)
			}
		},
		{
			path: '/SureInvoice',
			component: function(resolve) {
				require(['@/components/fukuan/SureInvoice'], resolve)
			}
		},
		{
			path: '/SureInvoice2',
			component: function(resolve) {
				require(['@/components/fukuan/SureInvoice2'], resolve)
			}
		},
		{
			path: '/InvoicePay',
			component: function(resolve) {
				require(['@/components/fukuan/InvoicePay'], resolve)
			}
		},
		{
			path: '/Reapply',
			component: function(resolve) {
				require(['@/components/fukuan/Reapply'], resolve)
			}
		}
	]
})
