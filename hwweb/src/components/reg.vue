            ...
            <div class="content">
                ...
                <div class="login-box">
                    <div class="login-info">
                        <p>输入手机号</p>
                        <input type="text" v-model='loginName' name="" id="" value="" />
                        <p>
                            <input type="checkbox" name="" id="" value="" />记住账号</p>
                    </div>
    
                    <div class="login-info">
                        <p>输入密码</p>
                        <input type="password" v-model='loginPassword' name="" id="" value="" />
                        <p>
        ...
        <div class="reg-box-warp">
            ...
            <div class="content-warp">
                <div class="reg-box">
                    <h1>注册新机构</h1>
                    <label for="">
                        <input type="text" name="" id="" value="" placeholder="输入机构名" v-model='jgname' />
                    </label>
                    <label for="">
...
export default {
    ...
    methods: {
        ...
        goReg() {
            ...
            this.$http.get(this.enHttp + '/mobile/institution/register?phone=' + this.regUsername + '&code=' + this.regCode + '&password=' + this.regRePwd + '&name=' + this.jgname).then(
                (res) => {
                    let _this = this
                    if (res.data.success) {
                        this.$message({
