...
module.exports = React.createClass({
            ...
            render: function() {
                    ...
                    var roomMember = [];
                    var keyValue = 0;
                    roomMember.push( < span key = { keyValue++ }
                                        ...
                                        if (WebIM.config.isWebRTC && Demo.selectedCate == 'friends') {
                                            roomMember.push( < span key = { keyValue++ }
                                                ...
                                                return ( <
                                                    ...
                                                    <
                                                    div className = 'webim-chatwindow-options' > { roomMember } <
                                                    /div> <
                                                    ul ref = 'emoji'
                                                    onClick = { this.selectEmoji }
                                                    className = { showEmoji } > < /ul> <
                                                    textarea ref = 'textarea'
                                                    onKeyDown = { this.handleKeyDown } > < /textarea> <
                                                    Button className = { 'webim-send-btn base-bgcolor' + disabled }
                                                    text = { Demo.lan.send }
